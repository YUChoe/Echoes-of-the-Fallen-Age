...
class MessageHandler {
    ...
    handleCommandSpecificActions(data) {
        ...
        switch (action) {
            ...
            case 'look_refresh':
                // look 명령어로 인한 방 정보 새로고침 - 몬스터 정보 포함하여 다시 표시
                console.log('방 정보 새로고침 요청 - 몬스터 정보 포함하여 표시');
                // room_info 메시지가 별도로 전송되므로 여기서는 로그만 남김
                // 중복 표시를 방지하지 않고 room_info 메시지가 정상 처리되도록 함
                break;
        }
