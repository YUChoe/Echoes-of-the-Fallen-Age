...
- [ ] 23.3. 기본 전투 메커니즘 구현
  ...
  - CombatSystem 클래스 구현 (공격/방어 계산)
  - 간소화된 D&D 룰 기반 데미지 계산 로직
  - 회피 및 크리티컬 히트 시스템
  - attack 명령어 기본 구현 (플레이어 → 몬스터)
  - _요구사항: 4.1, 4.2_

- [ ] 23.4. 전투 상태 관리 시스템 구현

  - CombatState 클래스 구현 (전투 참여자, 턴 순서 관리)
  - 전투 중 이동 제한 로직
  - 턴 기반 액션 처리 시스템
  - flee, defend 명령어 구현
  - _요구사항: 4.1, 4.2_

- [ ] 23.5. 몬스터 AI 및 어그로 시스템 구현
