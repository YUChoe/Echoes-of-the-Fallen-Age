...
- [x] 1. Init_Script 작성 — scripts/update_worldview.py
  - [x] 1.1 기존 NPC UPDATE 로직 구현
...
- [ ] 3. Lua 대화 스크립트 수정 — 기존 NPC 5건
  ...
  - [x] 3.2 Crypt Guard Monk → Necropolis Monk(b2f6d7a8-...) Lua 스크립트 수정
  ...
  - [x] 3.3 Wandering Bard(f0d4b5e6-...) Lua 스크립트 수정
  ...
  - [x] 3.4 Drunken Refugee(e9c3a4d5-...) Lua 스크립트 수정
    - 기존 대화(원정 경험, 대마법사) 유지
  ...
  - [x] 3.5 Royal Adviser(a7e1c2f3-...) Lua 스크립트 수정
...
- [ ] 4. Lua 대화 스크립트 생성 — Brother Marcus 및 신규 NPC 3건
  - [x] 4.1 Brother Marcus(3914fbe8-...) Lua 스크립트 생성
    - 예배당 수도승 역할에 맞는 인사말
...
- [ ] 6. JSON 아이템 템플릿 수정/생성
  ...
  - [x] 6.2 relocation_order.json 생성
